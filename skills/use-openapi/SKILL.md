...
1. Update the `openapi.yml` file in the project root directory to add or update terms and definitions as needed.
2. Refer to the `openapi.yml` file in the project root directory when working with AI agents or when adding or updating documents and coding.
3. Use the updated `openapi.yml` file to generate code following:
